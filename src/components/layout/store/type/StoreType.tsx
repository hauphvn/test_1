...
import { useStoreTypeStyles } from "./Style";
...
export function StoreType(props: StoreTypeProps) {
	const classes = useStoreTypeStyles();
	...
	return (
		<div className={classes.rootStoreType}>
			<Breadcrumbs title={"Type"} text={"Management all type"} />
			<div className={classes.storeTypeContainer}>
				<div className={classes.storeTypeFilterHeader}>
				...
				<div className={classes.storeTypeTable}>
